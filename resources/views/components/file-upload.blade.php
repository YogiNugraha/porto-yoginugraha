...
<div x-data="{ 
    ...
    <div 
        ...
        :class="{ 'border-primary bg-primary-light': isDropping, 'border-gray-300': !isDropping }"
        class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors relative overflow-hidden"
        ...
        <template x-if="!previewUrl">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p x-show="fileName" x-text="fileName" class="mt-2 text-sm font-medium text-primary"></p>
            </div>
        </template>
