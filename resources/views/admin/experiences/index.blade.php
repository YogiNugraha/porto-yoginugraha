<x-admin-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold text-slate-900">Manage Experiences</h2>
        <a href="{{ route('experiences.create') }}" class="px-4 py-2 bg-sky-500 text-white text-sm font-medium rounded-lg hover:bg-sky-600 transition-colors">Add New Item</a>
    </div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 font-medium text-slate-900">{{ $experience->title }}</td>
                            <td class="px-6 py-4 text-slate-500">{{ $experience->company }}</td>
                            <td class="px-6 py-4 text-slate-500">{{ $experience->date_range }}</td>
                            <td class="px-6 py-4 text-center text-slate-500">{{ $experience->order }}</td>
                            <td class="px-6 py-4 text-right space-x-3">
                                <a href="{{ route('experiences.edit', $experience) }}" class="text-sky-500 hover:underline font-medium">Edit</a>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-slate-500">No experiences found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
