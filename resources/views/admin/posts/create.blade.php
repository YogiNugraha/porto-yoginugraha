        ...
        <div class="p-6">
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" id="title" class="bg-white border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5" value="{{ old('title') }}" required>
                ...
                <div class="mb-5">
                    <div class="flex items-start">
                        <input id="is_published" name="is_published" type="checkbox" value="1" class="h-4 w-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" {{ old('is_published') ? 'checked' : '' }}>
                        <div class="ml-3">
