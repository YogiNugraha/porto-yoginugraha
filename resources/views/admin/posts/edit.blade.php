        ...
        <div class="p-6">
            <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" id="title" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" value="{{ old('title', $post->title) }}" required>
                ...
                <div class="mb-5">
                    <div class="flex items-start">
                        <input id="is_published" name="is_published" type="checkbox" value="1" class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary mt-0.5" {{ old('is_published', $post->is_published) ? 'checked' : '' }}>
                        <div class="ml-3">
