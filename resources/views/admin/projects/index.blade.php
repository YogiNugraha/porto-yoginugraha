    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('projects.create') }}" class="px-4 py-2 bg-sky-500 text-white text-sm font-medium rounded-lg hover:bg-sky-600 transition-colors">Add New</a>
            </div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-4 text-slate-500">{{ $project->order }}</td>
                            ...
                            <td class="px-6 py-4 text-right space-x-3">
                                <a href="{{ route('projects.edit', $project) }}" class="text-sky-500 hover:underline font-medium">Edit</a>
