            ...
            <form action="{{ route('skills.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="e.g. Laravel" required>
                ...
                <div class="mb-5 p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" id="image_url" name="image_url" value="{{ old('image_url') }}" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="https://cdn.jsdelivr.net/gh/devicons/...">
